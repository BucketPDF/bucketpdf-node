...
PDFBucket.prototype.generatePlainUrl = function(uri, orientation, pageSize, margin, zoom) {
  if (uri.trim() &&
      (orientation == "portrait" || orientation == "landscape") &&
      (pageSize == "A4" || pageSize == "Letter")) {
    var signature = sign(this.apiSecret, this.apiKey, uri, orientation, pageSize, margin, zoom);
...
function sign(apiSecret, apiKey, uri, orientation, pageSize, margin, zoom) {
