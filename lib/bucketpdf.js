...
function Signer(params) {
  this.apiKey    = (params && params.apiKey)    || process.env.BUCKET_PDF_API_KEY;
  this.apiSecret = (params && params.apiSecret) || process.env.BUCKET_PDF_API_SECRET;
  this.apiHost   = (params && params.apiHost)   || process.env.BUCKET_PDF_API_HOST || DEFAULT_HOST;
